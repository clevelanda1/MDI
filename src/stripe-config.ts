...
export const SUBSCRIPTION_TIERS = {
  free: {
    ...
    limits: {
      ...
      apiCalls: 40,
      visionBoards: 1,
      etsyCalls: 25 // Updated: reduced from 40 to 25
    },
    features: [
      'AI Image analysis',
      '4 active projects',
      '40 Amazon searches/month',
      '25 Etsy searches/month', // Updated
  ...
  pro: {
    ...
    limits: {
      ...
      apiCalls: 200,
      visionBoards: 12,
      etsyCalls: 125 // Updated: reduced from 200 to 125
    },
    features: [
      'Everything in Free',
      '25 active projects',
      '200 Amazon searches/month',
      '125 Etsy searches/month', // Updated
  ...
  studio: {
    ...
    limits: {
      ...
      etsyCalls: 750 // Updated: reduced from 1200 to 750
    },
    features: [
      'Everything in Pro',
      'Unlimited projects',
      '1,200 monthly Amazon search credits',
      '750 monthly Etsy search credits', // Updated
