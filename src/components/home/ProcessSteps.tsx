                      ...
                      <div className="mb-6">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center gap-2 p-2 bg-orange-50 rounded-lg border border-orange-200">
                            ...
                            <span className="ml-auto text-xs text-orange-600 bg-orange-100 px-1.5 py-0.5 rounded-full">24</span>
                          </div>
                          <div className="flex items-center gap-2 p-2 bg-emerald-50 rounded-lg border border-emerald-200">
                            <div className="w-3 h-3 rounded-sm bg-emerald-500"></div>
                            <span className="text-xs text-slate-600 font-medium">Etsy</span>
                            <span className="ml-auto text-xs text-emerald-600 bg-emerald-100 px-1.5 py-0.5 rounded-full">12</span>
                          </div>
                          {/*<div className="flex items-center gap-2 p-2 rounded-lg">
                            <div className="w-3 h-3 rounded-sm bg-slate-300"></div>
                            <span className="text-xs text-slate-600">Wayfair</span>
                            <span className="ml-auto text-xs text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded-full">0</span>
                          </div>*/}
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      >
                        <div className="aspect-square relative overflow-hidden">
                          ...
                          {/* AI Enhanced Badge */}
                          <div className="absolute bottom-2 left-2 bg-teal-500/90 text-white text-xs px-2 py-1 rounded-full font-medium">
                            Etsy
                          </div>
                        </div>
                        <div className="p-4">
                      ...
                      <div className="bg-white/80 rounded-xl overflow-hidden border border-slate-200/60">
                        <div className="aspect-square relative overflow-hidden">
                          ...
                          />
                          {/* Fallback */}
                          <div className="hidden w-full h-full bg-gradient-to-br from-violet-100 to-purple-100 items-center justify-center">
                            <div className="w-10 h-6 bg-violet-400 rounded-lg"></div>
                          </div>
                          {/* Heart Icon */}
                          <div className="absolute top-2 right-2 w-6 h-6 bg-white/80 rounded-full flex items-center justify-center">
                            <span className="text-xs">♡</span>
                        ...
                        <div className="p-4">
                          <h4 className="font-semibold text-slate-900 text-sm mb-1 line-clamp-1">Sectional Sofa</h4>
                          <div className="flex items-center mb-2">
                            <div className="flex text-yellow-400 text-xs">★★★★★</div>
                            <span className="text-xs text-slate-500 ml-1">(192)</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="font-semibold text-slate-900">$1,299</span>
                            <div className="bg-slate-200 text-slate-700 text-xs px-3 py-1 rounded-full">
                              View
                            </div>
                          </div>
                      ...
                      <div className="bg-white/80 rounded-xl overflow-hidden border border-slate-200/60">
                        <div className="aspect-square relative overflow-hidden">
                          ...
                          {/* Fallback */}
                          <div className="hidden w-full h-full bg-gradient-to-br from-amber-100 to-orange-100 items-center justify-center">
                            <div className="w-10 h-6 bg-amber-400 rounded-lg"></div>
                          </div>
                          {/* Heart Icon */}
                          <div className="absolute top-2 right-2 w-6 h-6 bg-white/80 rounded-full flex items-center justify-center">
                            <span className="text-xs">♡</span>
                        ...
                        <div className="p-4">
                          <h4 className="font-semibold text-slate-900 text-sm mb-1 line-clamp-1">Round Coffee Table</h4>
                          <div className="flex items-center mb-2">
                            <div className="flex text-yellow-400 text-xs">★★★★☆</div>
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <span className="text-xs text-slate-500 line-through ml-2">$329</span>
                            </div>
                            <div className="bg-slate-200 text-slate-700 text-xs px-3 py-1 rounded-full">
                              View
                            </div>
                      ...
                      {/* Product 5 - Console Table */}
                      <div className="bg-white/80 rounded-xl overflow-hidden border border-slate-200/60">
                        <div className="aspect-square relative overflow-hidden">
                          <img 
                            src="/images/console-table.jpg" 
                            alt="Console Table"
                            className="w-full h-full object-cover"
                            onError={(e) => {
                              e.currentTarget.style.display = 'none';
                          ...
                          />
                          {/* Fallback */}
                          <div className="hidden w-full h-full bg-gradient-to-br from-brown-100 to-amber-100 items-center justify-center">
                            <div className="w-10 h-4 bg-amber-400 rounded border-2 border-amber-500"></div>
                          </div>
                          {/* Heart Icon */}
                          <div className="absolute top-2 right-2 w-6 h-6 bg-white/80 rounded-full flex items-center justify-center">
                            <span className="text-xs">♡</span>
                        ...
                        <div className="p-4">
                          <h4 className="font-semibold text-slate-900 text-sm mb-1 line-clamp-1">Console Table</h4>
                          <div className="flex items-center mb-2">
                            <div className="flex text-yellow-400 text-xs">★★★★☆</div>
                            <span className="text-xs text-slate-500 ml-1">(156)</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="font-semibold text-slate-900">$449</span>
                            <div className="bg-slate-200 text-slate-700 text-xs px-3 py-1 rounded-full">
                              View
                            </div>
                          </div>
                      ...
                      <div className="bg-white/80 rounded-xl overflow-hidden border border-slate-200/60">
                        <div className="aspect-square relative overflow-hidden">
                          ...
                          <div className="hidden w-full h-full bg-gradient-to-br from-gray-100 to-slate-100 items-center justify-center">
                            <div className="w-10 h-4 bg-slate-400 rounded-lg"></div>
                          </div>
                          {/* Heart Icon */}
                          <div className="absolute top-2 right-2 w-6 h-6 bg-white/80 rounded-full flex items-center justify-center">
                            <span className="text-xs text-red-500">♥</span>
                          ...
                          {/* New Badge */}
                          <div className="absolute bottom-2 left-2 bg-orange-500/90 text-white text-xs px-2 py-1 rounded-full font-medium">
                            Amazon
                          </div>
                        </div>
                        <div className="p-4">
                          <h4 className="font-semibold text-slate-900 text-sm mb-1 line-clamp-1">Dining Table</h4>
                          <div className="flex items-center mb-2">
                            <div className="flex text-yellow-400 text-xs">★★★★★</div>
                            <span className="text-xs text-slate-500 ml-1">(73)</span>
                          </div>
                          <div className="flex items-center justify-between">
                            <span className="font-semibold text-slate-900">$799</span>
                            <div className="bg-slate-200 text-slate-700 text-xs px-3 py-1 rounded-full">
                              View
                            </div>
                          </div>
